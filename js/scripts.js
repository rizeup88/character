$(document).ready(function() {
  $("form#choices").submit(function(event) {
    ...
    if (gender) {
      ...
      if (gender === 'female' && (question1 === 'extro') && (question2 === 'fan') && (question3 === 'run') && (question4 === 'hide') && (question5 === 'live') && (question6 === 'english') && (question7 === 'not')) {
        character = ('Yumi Ishiyama');
        image = ('#yumi');
      } else if (gender === 'male' && (question1 === 'switch') && (question2 === 'sword') && (question3 === 'run') && (question4 === 'hide') && (question5 === 'half') && (question6 === 'physical') && (question7 === 'masc')) {
        character = ('Ulrich Stern');
        image = ('#ulrich');
      } else if (gender === 'male' && (question1 === 'extro') && (question2 === 'arrow') && (question3 === 'excuse') && (question4 === 'flirt') && (question5 === 'dog') && (question6 === 'love') && (question7 === 'masc')) {
        ...
        image = ('#william');
      } else if (gender === 'female' && (question1 === 'extro') && (question2 === 'voice') && (question3 === 'submit') && (question4 === 'flirt') && (question5 === 'spoiled') && (question6 === 'love') && (question7 === 'fem')) {
        character = ('Sissi Delmas');
        image = ('#sissi');
      } else if (gender === 'female' && (question1 === 'extro') && (question2 === 'skateboard') && (question3 === 'run') && (question4 === 'sneak') && (question5 === 'trouble') && (question6 === 'art') && (question7 === 'not')) {
